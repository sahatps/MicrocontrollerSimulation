...
export class FertilizerPhSensorElement extends LitElement {
  ...
  private svgContent() {
    return svg`
      <svg width="22mm" height="15mm" version="1.1" viewBox="0 0 80 55"
        ...
        <text x="30" y="20" fill="#ccc" font-family="Arial" font-size="3.5" text-anchor="middle">pH-MOD</text>

        <!-- pH symbol large -->
        <text x="10" y="38" fill="#a5d6a7" font-family="Arial" font-size="10" font-weight="bold" text-anchor="middle">pH</text>
        ...
        <circle cx="50" cy="47" r="2" fill="#a5d6a7" opacity="0.5"/>
...
customElements.define('fertilizer-ph-sensor-element', FertilizerPhSensorElement);
