...
export class Rs485RainSensorElement extends LitElement {
  ...
  private svgContent() {
    return svg`
      <svg width="22mm" height="15mm" version="1.1" viewBox="0 0 80 55"
        ...
        <text x="30" y="20" fill="#ccc" font-family="Arial" font-size="3.5" text-anchor="middle">JXBS-3001-YL</text>

        <!-- Rain drop icons -->
        <ellipse cx="8" cy="30" rx="3" ry="5" fill="#4fc3f7" stroke="#0288d1" stroke-width="0.4"/>
        <ellipse cx="15" cy="36" rx="2.5" ry="4" fill="#4fc3f7" stroke="#0288d1" stroke-width="0.4"/>
        <ellipse cx="8" cy="42" rx="2" ry="3.5" fill="#4fc3f7" stroke="#0288d1" stroke-width="0.4"/>
...
customElements.define('rs485-rain-sensor-element', Rs485RainSensorElement);
