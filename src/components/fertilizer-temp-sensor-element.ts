...
export class FertilizerTempSensorElement extends LitElement {
  ...
  private svgContent() {
    return svg`
      <svg width="22mm" height="15mm" version="1.1" viewBox="0 0 80 55"
        ...
        <text x="30" y="12" fill="#fff" font-family="Arial" font-size="4" font-weight="bold" text-anchor="middle">FERTILIZER</text>
        <text x="30" y="20" fill="#ccc" font-family="Arial" font-size="3.5" text-anchor="middle">TEMP-MOD</text>

        <!-- Thermometer icon -->
        <rect x="7" y="24" width="4" height="14" fill="#ffcc80" stroke="#e65100" stroke-width="0.4" rx="2"/>
        <circle cx="9" cy="40" r="4" fill="#ff7043" stroke="#e64a19" stroke-width="0.4"/>
        <!-- Temperature tick marks -->
        <line x1="11" y1="27" x2="14" y2="27" stroke="#ffcc80" stroke-width="0.6"/>
        <line x1="11" y1="30" x2="13" y2="30" stroke="#ffcc80" stroke-width="0.6"/>
        <line x1="11" y1="33" x2="14" y2="33" stroke="#ffcc80" stroke-width="0.6"/>
        <!-- °C label -->
        <text x="10" y="50" fill="#ffcc80" font-family="Arial" font-size="4" font-weight="bold" text-anchor="middle">°C</text>
        ...
        <circle cx="50" cy="47" r="2" fill="#ff7043" opacity="0.5"/>
...
customElements.define('fertilizer-temp-sensor-element', FertilizerTempSensorElement);
