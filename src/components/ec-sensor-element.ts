...
export class EcSensorElement extends LitElement {
  ...
  private svgContent() {
    return svg`
      <svg width="22mm" height="15mm" version="1.1" viewBox="0 0 80 55"
        ...
        <text x="30" y="12" fill="#fff" font-family="Arial" font-size="5" font-weight="bold" text-anchor="middle">EC SENSOR</text>
        <text x="30" y="20" fill="#ccc" font-family="Arial" font-size="3.5" text-anchor="middle">RS485-EC</text>

        <!-- Conductivity wave icon -->
        <path d="M 4 34 Q 7 28 10 34 Q 13 40 16 34" fill="none" stroke="#80deea" stroke-width="1.2" stroke-linecap="round"/>
        <path d="M 4 40 Q 7 34 10 40 Q 13 46 16 40" fill="none" stroke="#80deea" stroke-width="1.2" stroke-linecap="round"/>
        <!-- EC label -->
        <text x="10" y="50" fill="#80deea" font-family="Arial" font-size="4" font-weight="bold" text-anchor="middle">EC</text>
        ...
        <circle cx="50" cy="47" r="2" fill="#80deea" opacity="0.5"/>
...
customElements.define('ec-sensor-element', EcSensorElement);
